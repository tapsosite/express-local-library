...
exports.bookinstance_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (err) { return next(err); }
        //Success
        if (results.bookinstance.book>0) {
            //BookInstance has book. Render in same way as for GET route.
            res.render('bookinstance_delete', { title: 'Delete Book Copy', bookinstance: results.bookinstance } );
            return;
        }
        else {
            //BookInstace has no book. Delete object and redirect to the list of bookinstances.
